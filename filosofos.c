...
int main(int argc, char ** argv)
{
    ...
    // vetor de semaforos, um para cada chopstick
    chopsticks = malloc(N_FILOS * sizeof(sem_t));
...
void * filosofo(void * id)
{
    ...
    //
    // garante que mais de um filosofo nao pegue o mesmo chopstick simultaneamente
    //
    pegar(i, c1);
    pegar(i, c2);
    ...
    //
    // garante que os filosofos liberem os chopsticks após usar
    //
    liberar(i, c1);
    liberar(i, c2);
